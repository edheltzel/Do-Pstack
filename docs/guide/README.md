...
> This numbered guide is the original pstack product tutorial. On this omp fork, first-run is [Getting started](../getting-started.md). Slash skills are `/skill:ps-…` (on-disk `skills/ps-*`). `/poteto-mode` stays unprefixed.
